...
public class BurnoutTorchBlock extends TorchBlock implements BurnoutForgeBlock {
	
	private String translationKey;
	  
	public BurnoutTorchBlock(Properties properties, IParticleData particleData) {
