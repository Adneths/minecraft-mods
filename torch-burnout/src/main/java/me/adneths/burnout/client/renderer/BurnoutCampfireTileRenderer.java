package me.adneths.burnout.client.renderer;
...
@OnlyIn(Dist.CLIENT)
public class BurnoutCampfireTileRenderer extends TileEntityRenderer<BurnoutCampfireTile> {

	public BurnoutCampfireTileRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(BurnoutCampfireTile tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
