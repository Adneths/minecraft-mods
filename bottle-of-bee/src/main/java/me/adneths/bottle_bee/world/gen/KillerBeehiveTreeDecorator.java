package me.adneths.bottle_bee.world.gen;
...
public class KillerBeehiveTreeDecorator extends BeehiveTreeDecorator {

		public static final Codec<KillerBeehiveTreeDecorator> field_236863_a_ = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(KillerBeehiveTreeDecorator::new, (p_236865_0_) -> {
			return p_236865_0_.probability;
		}).codec();
		
		private final float probability;

		public KillerBeehiveTreeDecorator(float probabilityIn) {
			super(probabilityIn);
			this.probability = probabilityIn;
		}
		
		protected TreeDecoratorType<?> func_230380_a_() {
			return ModTreeDecoratorType.KILLER_BEEHIVE;
		}
		...
		public void func_225576_a_(ISeedReader p_225576_1_, Random p_225576_2_, List<BlockPos> p_225576_3_, List<BlockPos> p_225576_4_, Set<BlockPos> p_225576_5_, MutableBoundingBox p_225576_6_) {
			if (p_225576_2_.nextFloat() < this.probability)
			{
				...
				if (!list.isEmpty())
				{
					...
					{
						if(p_225576_2_.nextFloat() < 1)//0.1)
						{
							BlockState blockstate = ModContents.Blocks.KILLER_BEE_NEST.getDefaultState().with(BeehiveBlock.FACING, Direction.SOUTH);
							...
							{
								KillerBeehiveTile beehivetileentity = (KillerBeehiveTile)tileentity;
								int j = 2 + p_225576_2_.nextInt(4);
								
								for(int k = 0; k < j; ++k)
								{
									KillerBeeEntity beeentity = new KillerBeeEntity(ModContents.Entities.KILLER_BEE, p_225576_1_.getWorld());
