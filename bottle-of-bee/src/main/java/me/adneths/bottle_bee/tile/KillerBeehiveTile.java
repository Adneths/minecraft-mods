package me.adneths.bottle_bee.tile;
...
public class KillerBeehiveTile extends TileEntity implements ITickableTileEntity {
	private final List<KillerBeehiveTile.Bee> bees = Lists.newArrayList();
	@Nullable
	private BlockPos flowerPos = null;

	public KillerBeehiveTile() {
		super(ModContents.TileEntities.KILLER_BEEHIVE);
	}

	public void markDirty() {
		if (this.isNearFire()) {
			this.angerBees((PlayerEntity) null, this.world.getBlockState(this.getPos()), KillerBeehiveTile.State.EMERGENCY);
		}
	...
	public void angerBees(@Nullable PlayerEntity p_226963_1_, BlockState p_226963_2_,
			KillerBeehiveTile.State p_226963_3_) {
	...
	private List<Entity> tryReleaseBee(BlockState p_226965_1_, KillerBeehiveTile.State p_226965_2_) {
	...
	public void tryEnterHive(Entity p_226962_1_, boolean p_226962_2_, int p_226962_3_) {
		if (this.bees.size() < 6) {
			...
			this.bees.add(new KillerBeehiveTile.Bee(compoundnbt, p_226962_3_, p_226962_2_ ? 2400 : 600));
			if (this.world != null) {
				if (p_226962_1_ instanceof KillerBeeEntity) {
					KillerBeeEntity beeentity = (KillerBeeEntity) p_226962_1_;
	...
	private boolean func_235651_a_(BlockState p_235651_1_, KillerBeehiveTile.Bee p_235651_2_,
			@Nullable List<Entity> p_235651_3_, KillerBeehiveTile.State p_235651_4_) {
		if ((this.world.isNightTime() || this.world.isRaining()) && p_235651_4_ != KillerBeehiveTile.State.EMERGENCY) {
			return false;
		} else {
			BlockPos blockpos = this.getPos();
			...
			if (flag && p_235651_4_ != KillerBeehiveTile.State.EMERGENCY) {
				return false;
			} else {
				...
				if (entity != null) {
					if (!entity.getType().equals(ModContents.Entities.KILLER_BEE)) {
						return false;
					} else {
						if (entity instanceof KillerBeeEntity) {
							KillerBeeEntity beeentity = (KillerBeeEntity) entity;
							if (this.hasFlowerPos() && !beeentity.hasFlower() && this.world.rand.nextFloat() < 0.9F) {
								beeentity.setFlowerPos(this.flowerPos);
							}

							if (p_235651_4_ == KillerBeehiveTile.State.HONEY_DELIVERED) {
								beeentity.onHoneyDelivered();
								if (p_235651_1_.getBlock().equals(ModContents.Blocks.KILLER_BEE_NEST)) {
									...
									if (i < 5) {
										...
										this.world.setBlockState(this.getPos(),
												p_235651_1_.with(BeehiveBlock.HONEY_LEVEL, Integer.valueOf(i + j)));
									}
								}
							}
	...
	private void func_235650_a_(int p_235650_1_, KillerBeeEntity p_235650_2_) {
	...
	private void tickBees() {
		Iterator<KillerBeehiveTile.Bee> iterator = this.bees.iterator();

		KillerBeehiveTile.Bee beehive$bee;
		for (BlockState blockstate = this.getBlockState(); iterator.hasNext(); beehive$bee.ticksInHive++) {
			beehive$bee = iterator.next();
			if (beehive$bee.ticksInHive > beehive$bee.minOccupationTicks) {
				System.out.println(beehive$bee.entityData.getBoolean("HasNectar"));
				KillerBeehiveTile.State beehivetileentity$state = beehive$bee.entityData.getBoolean(
						"HasNectar") ? KillerBeehiveTile.State.HONEY_DELIVERED : KillerBeehiveTile.State.BEE_RELEASED;
				if (this.func_235651_a_(blockstate, beehive$bee, (List<Entity>) null,
	...
	public void read(BlockState state, CompoundNBT nbt) {
		...
		for (int i = 0; i < listnbt.size(); ++i) {
			...
			KillerBeehiveTile.Bee beehivetileentity$bee = new KillerBeehiveTile.Bee(
	...
	public ListNBT getBees() {
		...
		for (KillerBeehiveTile.Bee beehivetileentity$bee : this.bees) {
