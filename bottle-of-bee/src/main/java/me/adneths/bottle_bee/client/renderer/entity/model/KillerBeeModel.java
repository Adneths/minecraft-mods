package me.adneths.bottle_bee.client.renderer.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class KillerBeeModel<T extends KillerBeeEntity> extends AgeableModel<T> {
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		if (!entityIn.func_233678_J__()) {
			...
			if (!flag) {
				...
				this.body.rotateAngleX = 0.1F + f1 * 3.1415927F * 0.025F;
				this.leftAntenna.rotateAngleX = f1 * 3.1415927F * 0.03F;
				this.rightAntenna.rotateAngleX = f1 * 3.1415927F * 0.03F;
				this.frontLegs.rotateAngleX = -f1 * 3.1415927F * 0.1F + 0.3926991F;
				this.backLegs.rotateAngleX = -f1 * 3.1415927F * 0.05F + 0.7853982F;
